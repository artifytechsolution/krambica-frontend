...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white py-16 lg:py-20 hidden md:block">
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">+91 (0) 79 2345 6789</p>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">help@freshbucket.com</p>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Gujarat, India 380001</p>
                </div>
              </li>
            </ul>
          </div>
